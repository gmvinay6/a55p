...
#create a directory
ansible all -m file -a "path=/tmp/ansible55 state=directory"

#create a file
ansible all -m file -a "path=/tmp/ansible55/content state=touch"

#remove a directory
ansible all -m file -a "path=/tmp/ansible55 state=absent"
